...
| `android.permission.FOREGROUND_SERVICE_LOCATION` | Enables the app to track the real-time location of drivers during cargo transportation. This service runs in the foreground, ensuring that users are always aware of its operation through a persistent notification. It is essential for providing real-time tracking, enhancing safety, and improving operational efficiency, even when the app is not in the foreground. |
